...
OutputBaseFilename=stellarium-patch-0.13.0-win64
...
[Files]
Source: "C:/Program Files/Stellarium/bin/stellarium.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:/Program Files/Stellarium/lib/libstelMain.dll"; DestDir: "{app}"; Flags: ignoreversion
...
;Source: "C:/Program Files/Stellarium\share\stellarium\data\default_shortcuts.json"; DestDir: "{app}\data"
...
;Source: "release-notes.txt"; DestDir: "{app}"; Flags: isreadme; DestName: "Release Notes (0.13.0).txt"
...
;Name: "{group}\Release Notes (0.13.0)"; Filename: "{app}\Release Notes (0.13.0).txt"
