...
rd C:\Users\Owner\Dropbox\Third Year\Semester 1\CS 3205\stellarium\locale
cd C:\Users\Owner\Dropbox\Third Year\Semester 1\CS 3205\stellarium\builds\msvc\po\stellarium

for %%f in (*.gmo) do (
set d=C:\Users\Owner\Dropbox\Third Year\Semester 1\CS 3205\stellarium\locale\%%~nf\LC_MESSAGES\
md !d!
